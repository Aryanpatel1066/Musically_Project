...
<style>
	body{
		...
		background: linear-gradient(338deg, rgba(0,0,0,1) 14%, rgba(154,136,36,1) 41%, rgba(130,120,120,140) 53%, rgba(100,0,0,1) 92%);
	    /*background: #007bff;*/
	}
	main#main{
		width:100%;
  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				...
  				<h2 class="text-gradient-primary"><b>Musically</b></h2>
  				</span>
  			</div>
