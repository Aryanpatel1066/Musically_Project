...
<!-- Info boxes -->
         <div class="row">
          <div class="col-5 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-Light ">
              <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-th-list text-gradient-Light"></i></span>
          ...
          <!-- /.col -->
            ...
            <div class="info-box bg-black border border-Light">
              <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-music text-gradient-Light"></i></span>
          ...
          <!-- /.col -->
            <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-Light">
              <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-list text-gradient-Light"></i></span>
           ...
           <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-Light">
              <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-users text-gradient-Light"></i></span>
